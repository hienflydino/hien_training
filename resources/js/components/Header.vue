<template>
    <header>
        <nav
            class="relative flex w-full items-center justify-between bg-neutral-900 py-2 text-white shadow-lg md:flex-wrap md:justify-start"
            data-te-navbar-ref
        >
            <div
                class="flex w-full flex-wrap items-center justify-between px-6"
            >
                ...
                >
                    ...
                    >
                        <li data-te-nav-item-ref>
                            <a
                                class="block transition duration-150 ease-in-out hover:text-slate-400 focus:text-slate-400 dark:bg-neutral-600 dark:text-neutral-200 lg:p-2 [&.active]:text-black/90"
                                href="#!"
                ...
                <div
                    class="flex flex-nowrap items-center sm:justify-end justify-between"
                >
                    <img
                        src="https://resources.premierleague.com/premierleague/photos/players/250x250/man51018.png"
                        width="50"
                        height="50"
                        class="rounded-full bg-white sm:mr-3 mr-0"
                    />
                    <p class="sm:inline hidden">Nguyễn Trọng Hiền</p>
                </div>
            </div>
        </nav>
        <div
